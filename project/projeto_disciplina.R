...
df_all %>%
    mutate(qty = 1, order_hour_of_day = as.numeric(order_hour_of_day)) %>%
...
# Há uma similaridade clara em 30 dias.
# O que parece indicar que os mesmos usuários tem tendência a ficar 30 dias sem comprar,
# ou denota uma concentração de usuários que fizeram poucas compras.
